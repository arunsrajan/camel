...
docker run --network redis_redisnet --name springboot1 -p 1090:1090 -v "C:/DEVELOPMENT:/DEVELOPMENT" -d springbootcamel
docker run --network redis_redisnet --name springboot2 -p 1091:1090 -v "C:/DEVELOPMENT:/DEVELOPMENT" -d springbootcamel

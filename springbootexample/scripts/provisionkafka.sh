...
docker run --network springboot --name springboot1 -p 1090:1090 -v "C:/DEVELOPMENT:/DEVELOPMENT" -d arunsrajan/springbootcamel
docker run --network springboot --name springboot2 -p 1091:1090 -v "C:/DEVELOPMENT:/DEVELOPMENT" -d arunsrajan/springbootcamel
